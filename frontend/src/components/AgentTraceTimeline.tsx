...
export function AgentTraceTimeline({
  ...
  return (
    ...
    >
      <details>
        <summary className="agent-trace__heading">
          <div>
        ...
        <dl className="agent-trace__summary">
          <div>
            ...
            <dd>
              {run.selected_intent
                ? displayLabel(run.selected_intent)
                : 'not evaluated'}
            </dd>
          </div>
          <div>
            <dt>Policy decision</dt>
            <dd>{displayLabel(run.policy_decision)}</dd>
          </div>
          <div>
            <dt>Tool shortlist</dt>
            <dd>
              {run.tool_shortlist.length > 0
                ? run.tool_shortlist.join(', ')
                : 'none'}
            </dd>
          </div>
          <div>
            <dt>Plan version</dt>
            <dd>{run.plan_version ?? 'none'}</dd>
          </div>
          <div>
            <dt>Evidence advanced goal</dt>
            <dd>{run.evidence_advanced_goal ? 'yes' : 'no'}</dd>
          </div>
          <div>
